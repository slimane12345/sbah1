...
const DriverSidebar: React.FC<DriverSidebarProps> = ({ activeView, setActiveView }) => {
    ...
    const navItems: { id: DriverView; label: string; icon: React.ReactNode }[] = [
        ...
        { id: 'active_orders', label: t('myActiveOrders'), icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" /></svg> },
