...
const LanguageSettings: React.FC = () => {
  ...
  const handleAutoTranslateUI = async (targetLang: 'fr') => {
    ...
    try {
        ...
        const keysToTranslate = Object.keys(sourceTranslations).filter(key => !targetTranslations[key] || targetTranslations[key] === '');
        ...
        const prompt = `Translate the JSON values from Arabic to French. Keep the original keys. Return only the valid JSON object.\n\nInput:\n${JSON.stringify(batchToTranslate)}\n\nOutput:`;
