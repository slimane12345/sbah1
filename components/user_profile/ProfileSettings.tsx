             ...
             <Card>
                ...
                <div className="mt-4 flex gap-4">
                    <button
                        ...
                        className={`px-6 py-2 rounded-md font-semibold text-sm transition-colors ${language === 'ar' ? 'bg-blue-600 text-white shadow' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
                    >
                        {t('arabic')}
                    </button>
                    <button
                        onClick={() => setLanguage('fr')}
                        className={`px-6 py-2 rounded-md font-semibold text-sm transition-colors ${language === 'fr' ? 'bg-blue-600 text-white shadow' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
                    >
                        {t('french')}
                    </button>
                </div>
