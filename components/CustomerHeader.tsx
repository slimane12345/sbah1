...
import type { CustomerPage, ViewMode, CartItem, AppSettings } from '../types';
...
const CustomerHeader: React.FC<CustomerHeaderProps> = ({ setViewMode, setCustomerPage, cartItems, setCartItems, showAdminButton, settings }) => {
        ...
        <div className="flex justify-between items-center py-3 gap-4">
          ...
          <div className="flex items-center space-x-2 flex-shrink-0" ref={cartRef}>
            <button onClick={() => setCustomerPage('profile')} className="p-2 rounded-full hover:bg-gray-100 transition-colors">
             ...
             {showAdminButton && (
                <button onClick={() => setViewMode('admin')} className="p-2 rounded-full hover:bg-gray-100 transition-colors" title={t('returnToDashboard')}>
