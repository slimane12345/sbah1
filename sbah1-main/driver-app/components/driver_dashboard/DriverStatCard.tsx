...
const colorMap = {
    ...
    thumbUp: 'bg-indigo-100 text-indigo-600',
};

const DriverStatCard: React.FC<DriverStatCardProps> = ({ title, value, icon }) => {
    return (
        <div className="bg-white p-4 rounded-lg shadow-sm flex items-center gap-4">
            <div className={`p-3 rounded-full ${colorMap[icon]}`}>
                {iconMap[icon]}
            </div>
            <div>
